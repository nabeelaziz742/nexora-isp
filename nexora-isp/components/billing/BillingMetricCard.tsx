...
import { BillingMetric } from "@/types/billing";
...
const metricIcons = {
  "monthly-billing": Banknote,
  "collected-revenue": CheckCircle2,
  outstanding: AlertTriangle,
  "grace-period": Clock3,
  suspended: ShieldOff,
  "restore-pending": RefreshCw,
};
...
export default function BillingMetricCard({
  ...
  const Icon =
    metricIcons[metric.id as keyof typeof metricIcons] ?? Banknote;
