      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold tracking-tight text-slate-100 sm:text-2xl">Inventory & Hardware</h1>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            className="inline-flex h-8.5 items-center gap-1.5 rounded-lg border border-slate-700 bg-slate-800/80 px-3 text-xs font-semibold text-slate-200 hover:bg-slate-700 transition"
          >
          ...
          {activeTab === "items" && (
            <button
              ...
              className="inline-flex h-8.5 items-center gap-1.5 rounded-lg bg-blue-600 px-3.5 text-xs font-semibold text-white shadow-xs hover:bg-blue-500 transition"
            >
