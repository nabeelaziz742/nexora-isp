      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold tracking-tight text-slate-100 sm:text-2xl">POS Hardware Terminal</h1>
            <span className="inline-flex items-center rounded-md bg-emerald-500/10 px-2 py-0.5 text-[11px] font-medium text-emerald-400 border border-emerald-500/20">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <Link
            href="/pos/sales"
            className="inline-flex h-8.5 items-center gap-2 rounded-lg border border-slate-700 bg-slate-800/80 px-3 text-xs font-semibold text-slate-200 hover:bg-slate-700 transition"
          >
          ...
          <button
            ...
            className="inline-flex h-8.5 items-center gap-2 rounded-lg border border-slate-700 bg-slate-800/80 px-2.5 text-xs font-semibold text-slate-200 hover:bg-slate-700 transition"
          >
