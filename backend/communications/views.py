...
class CommunicationProviderViewSet(
...
class CommunicationAutomationViewSet(
    CommunicationBaseViewSet
):
    queryset = (
    ...
    def execute_now(self, request, pk=None):
        ...
        CommunicationAutomationService.execute_automation(
...
class CommunicationScheduleViewSet(
    CommunicationBaseViewSet
):
    queryset = (
...
class CommunicationQueueViewSet(
    CommunicationBaseViewSet
):
...
class RetryCommunicationAPIView(APIView):
    ...
    def post(self, request, pk):
        log = get_object_or_404(
            CommunicationLog.objects.select_related(
                "queue",
            ),
            pk=pk,
            organization=request.organization,
...
class CommunicationTemplateViewSet(CommunicationBaseViewSet):
    queryset = CommunicationTemplate.objects.select_related(
    ...
    def get_queryset(self):
        ...
        if provider:
            queryset = queryset.filter(
                communication_provider_id=provider,
            )
                ...
                for change in entry.get("changes", []):
                    ...
                    for item in statuses:
                        ...
                        try:
                            ...
                            log = CommunicationLog.objects.select_related(
                                "queue",
                            ).get(
