...
class CommunicationAutomationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "organization", "name", "description", "trigger", "template",
            "template_name", "provider_name", "execution_order", "delay_minutes",
            "max_retry_attempts", "is_enabled", "last_executed_at",
            "last_execution_status", "created_at", "updated_at",
        ]
        read_only_fields = [
            "organization", "last_executed_at", "last_execution_status",
...
class CommunicationScheduleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "organization", "automation", "automation_name", "trigger",
            "provider_name", "frequency", "next_run", "last_run", "is_enabled",
            "created_at", "updated_at",
        ]
        read_only_fields = ["organization", "created_at", "updated_at", "last_run"]
...
class CommunicationQueueSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            "id", "organization", "customer", "template", "provider", "recipient",
            "payload", "rendered_subject", "rendered_body", "status", "priority",
            "scheduled_at", "sent_at", "retry_count", "attempts", "max_attempts",
            "processing_started_at", "processed_at", "next_retry_at", "error_message",
            "last_error", "provider_response", "locked_by", "lock_expires_at",
            "created_at", "updated_at",
        ]
        read_only_fields = [
            "organization", "status", "sent_at", "retry_count", "attempts",
            "processing_started_at", "processed_at", "next_retry_at", "error_message",
            "last_error", "provider_response", "locked_by", "lock_expires_at",
            "created_at", "updated_at",
        ]
...
class CommunicationLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "customer_name", "template_name", "communication_provider_name",
            "is_connected", "recipient", "subject", "message", "status",
            "provider_response", "provider_response_code", "error_message",
...
class BroadcastSerializer(serializers.Serializer):
    ...
    audience = serializers.ChoiceField(
        choices=[
            "ALL_CUSTOMERS", "AREA", "PACKAGE", "SELECTED_CUSTOMERS",
        ]
    )
